...
<div class="flex flex-col items-center h-full gap-4">
	...
	<div class="space-y-4">
		<p>
			...
			something, email
			<a class="anchor" href="mailto:simmons-tech@mit.edu">simmons-tech@mit.edu</a>, your friendly,
			teddy-bear-like guide to all things simmons-tech.
		</p>
		...
		<p>
			<span class="font-strong">Important note:</span> If you're unfamiliar with the new GovTracker system
		...
		<p>
			...
			(Note, however, that you need to be logged in by certificate in order to set up your password.)
		</p>
